<?php
    ...
    $result1 = mysqli_query($db, "SELECT * FROM tbl_food");
    ...
    $result = mysqli_query($db, "SELECT * FROM tbl_food ORDER BY id DESC LIMIT $this_page_first_result, $results_per_page");
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="manage_products.css">
</head>
<body>
	<div class="wrapper">
										...
										<thead class="thead-dark">
									  	...
									  	<tbody id="display">
									  		...
									  		?>
												    	<tr>
												      		<td>
												      			<img src="file1/<?php echo $data['image_name']; ?>" width="70px" height="70px" alt="img" class="img-fluid" style="border-radius: 50%;">
												      		</td>
