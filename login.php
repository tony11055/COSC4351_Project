...
<section>
  <div class="container">
    <div class="card">
      ...
      <p style="color: white; padding-left: 15px;">
        <br><br>
        <a style="color:#FFD700;text-decoration: none;" href="#">Forgot password?</a> &nbsp &nbsp &nbsp &nbsp &nbsp  
  ...
  <?php
    ...
    {
      $count=0;
      $res=mysqli_query($db,"SELECT * FROM `user_reg` WHERE user_name='$_POST[user_name]' && password='$_POST[password]';");
