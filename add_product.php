<?php
    ...
    $query_category = "SELECT * FROM tbl_category WHERE cat_id = 'category_id'";
    $result_category = mysqli_query($db, $query_category);
    ...
    if(isset($_POST['add']))
    {
		...
		if(filesize($_FILES['file']['tmp_name']))
		{
			if(move_uploaded_file($location, $path))
			{
				...
				if(!empty($title) || !empty($description) || !empty($price) || !empty($active) || !empty($category_id))
				{
					mysqli_query($db, "INSERT INTO tbl_food(image_name, title, description, price, active, category_id) VALUES('$file_name', '$title', '$description', '$price', '$active', '$category_id')");
					$msg = "Product added";
				}
				else
				{
								...
								<form method="POST" action="" enctype="multipart/form-data">
							    	...
							    	<div class="avatar-upload">
							        	...
							        	<div class="avatar-preview">
							            	<div id="imagePreview" style="background-image: url(preview.jpg);"></div>
							        	</div>
							    	</div>
							    	<div class="form-group">
								    	<label for="title" style="font-weight: 600;">Product Name</label>
								    	<input type="text" name="title" class="form-control shadow-none" id="title" placeholder="Enter Product Name">
								  	</div>
								  	<div class="form-group">
									...
									<div class="form-group">
									    ...
									    <select class="form-control shadow-none" id="category_id" name="category_id">
									    	<?php
									    		if($count_category > 0)
												{
									...
									<div class="form-group">
								    	...
								    	<select class="form-control shadow-none" id="active" name="active">
