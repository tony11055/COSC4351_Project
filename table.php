<?php
    ...
    $result1 = mysqli_query($db, "SELECT * FROM book_table");
    ...
    $result = mysqli_query($db, "SELECT * FROM book_table ORDER BY id DESC LIMIT $this_page_first_result, $results_per_page");
    $count = mysqli_num_rows($result);
	      		...
	      		<div class="modal-body">
	      			<form method="POST" action="" id="add_form">
						<div class="form-group">
					    	...
					    	<input type="text" name="table_name" class="form-control shadow-none" id="table_name" aria-describedby="emailHelp" placeholder="Enter Table Name">
					  	</div>
					  	<div class="form-group">
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$('#add_form').on('submit', function(e){
				e.preventDefault();
				if($('#table_name').val() == "" || $('#capacity').val() == "")
				{
