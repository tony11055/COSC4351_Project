							...
							<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-3 mx-auto total-products">
										...
										<a href="manage_product.php" class="btn btn-primary btn-sm w-100 mt-4 mx-auto text-center">View Products <i class="fas fa-arrow-circle-right"></i></a>
									</div>
									...
									<div class="col-md-3 mx-auto total-stores">
										...
										<a href="table.php" class="btn btn-danger btn-sm w-100 mt-4 mx-auto text-center">View tables <i class="fas fa-arrow-circle-right"></i></a>
									</div>
								</div>
							</div>
						</div>
