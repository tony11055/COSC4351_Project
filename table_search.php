<?php
	...
	$result = mysqli_query($db, "SELECT * FROM book_table WHERE table_name like ('%$search%') OR capacity like ('%$search%') OR availability like ('%$search%') OR status like ('%$search%') OR id like ('%$search%') ORDER BY id DESC ");
